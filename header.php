		...
		<!-- Logo -->
           ...
           <!-- Main Menu -->
            <div class="menu text-right">
                <ul>
                    <li>
                        <a class="hvr-underline-from-center" href="<?php echo SITEURL; ?>">Home</a>
                    </li>
                    <li>
                        <a class="hvr-underline-from-center" href="<?php echo SITEURL; ?>categories.php">Categories</a>
                    </li>
                    <li>
                        <a class="hvr-underline-from-center" href="<?php echo SITEURL; ?>foods.php">Foods</a>
                    </li>
                    <li>
                        <a class="hvr-underline-from-center" href="<?php echo SITEURL; ?>order.php">Order</a>
                    </li>
                    <li>
                        <a class="hvr-underline-from-center" href="<?php echo SITEURL; ?>contact.php">Contact</a>
                    </li>
                    <li>
                        <a class="hvr-underline-from-center" href="<?php echo SITEURL; ?>login.php">Login</a>
                    </li>
                    <li>
						 <a id="shopping-cart" class="shopping-cart">
						   ...
						   <div id="cart-content" class="cart-content">
								...
								<a href="<?php echo SITEURL; ?>order.php" class="btn btn-primary">Confirm Order</a>
							</div>
                    </li>
                </ul>
            </div>
