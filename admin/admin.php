								...
								<tr>
									...
									<td <?php if( isset($_SESSION['admin']) AND $_SESSION['admin'] != $email){echo "colspan='2'";} ?>>
										<?php 
											if(isset($_SESSION['admin'])){
										?>
												<a href="<?php echo SITEURL; ?>/admin/admin-update.php?id=<?php echo $id; ?>&&bt=ap" class="btn-warning">Edit</a>
									</td>
									<td class="text-center">
											<?php 
												if($_SESSION['admin'] == $email){
											?>
												<a href="<?php echo SITEURL; ?>/admin/admin-pwd-update.php?id=<?php echo $id; ?>&&bt=ap" class="btn-success">Change Password</a>
									</td>
									<td class="text-center">
												<?php
												}
												if($count!=1){
												?>
												<a href="<?php echo SITEURL; ?>/admin/admin-delete.php?id=<?php echo $id; ?>&&bt=ap" class="btn-danger" onclick="return confirm('Are you sure...?');">Delete</a>
												<?php
												}
											}
										?>
