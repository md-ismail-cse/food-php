							...
							while($rows = mysqli_fetch_assoc($res)){
								...
								<tr <?php if($status == "Ordered" OR $status=="On Delivery"){echo "class='bold'";} ?>>
									...
									<td class="text-center">
										<a href="<?php echo SITEURL; ?>/admin/order-update.php?id=<?php echo $id; ?>" class="btn-warning">Update</a>
									</td class="text-center">
									<td>
										<a href="<?php echo SITEURL; ?>/admin/order-delete.php?id=<?php echo $id; ?>" class="btn-danger" onclick="return confirm('Are you sure...?');">Delete</a>
									</td>
								</tr>
								<?php
							}
